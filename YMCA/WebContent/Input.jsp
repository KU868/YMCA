...
作成日:<input type="date" name="AA01SAKUSEMD" min="2000-01-01" max="3000-01-01" value = <%=con.fmtSlash(AA01SAKUSEMD)%>>
...
詳細<br>
<textarea name="AA01SYOUSAI" class="AA01SYOUSAI" id= "id_AA01SYOUSAI" rows="8" cols="80" style="margin: 0px; width: 708px; height: 236px;"><%=a2.getAA01SYOUSAI()%></textarea><br>
